...
//    pageData = dateFormatter.monthSymbols
  ...
  func viewControllerAtIndex(index: Int, storyboard: UIStoryboard) -> NSLayoutConstraintsViewController? {
  ...
  func indexOfViewController(viewController: NSLayoutConstraintsViewController) -> Int {
  ...
  func pageViewController(pageViewController: UIPageViewController, viewControllerBeforeViewController viewController: UIViewController) -> UIViewController? {
      var index = self.indexOfViewController(viewController as! NSLayoutConstraintsViewController)
  ...
  func presentationIndexForPageViewController(pageViewController: UIPageViewController) -> Int {
    guard let firstViewController = self.pageData.first,
      firstViewControllerIndex = self.pageData.indexOf(firstViewController) else {
        return 0
    }
